...
import { Accordion } from "@zerocode-ai/ui/accordion"
...
import {
  ...
  partDefaultOpen,
  type UserActions,
} from "@zerocode-ai/session-ui/message-part"
...
import { DropdownMenu } from "@zerocode-ai/ui/dropdown-menu"
import { MenuV2 } from "@zerocode-ai/ui/v2/menu-v2"
import { Dialog } from "@zerocode-ai/ui/dialog"
import { DialogFooter, DialogHeader, DialogTitleGroup, DialogV2 } from "@zerocode-ai/ui/v2/dialog-v2"
import { InlineInput } from "@zerocode-ai/ui/inline-input"
import { ButtonV2 } from "@zerocode-ai/ui/v2/button-v2"
import { SessionRetry } from "@zerocode-ai/session-ui/session-retry"
import { isScrollKeyTarget, scrollKey, scrollKeyOwner, ScrollView } from "@zerocode-ai/ui/scroll-view"
import { StickyAccordionHeader } from "@zerocode-ai/ui/sticky-accordion-header"
import { TextField } from "@zerocode-ai/ui/text-field"
import { TextReveal } from "@zerocode-ai/ui/text-reveal"
import { TextShimmer } from "@zerocode-ai/ui/text-shimmer"
import type {
  AssistantMessage,
...
import { normalize } from "@zerocode-ai/session-ui/session-diff"
import { useFileComponent } from "@zerocode-ai/ui/context/file"
