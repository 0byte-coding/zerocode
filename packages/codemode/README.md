...
{
  "dependencies": {
    "@zerocode-ai/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@zerocode-ai/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@zerocode-ai/codemode"
...
```ts
import { toolError } from "@zerocode-ai/codemode"
