...
{
  "dependencies": {
    "@0codeai/zerocode-codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@0codeai/zerocode-codemode"
...
```ts
import { CodeMode, OpenAPI } from "@0codeai/zerocode-codemode"
...
```ts
import { toolError } from "@0codeai/zerocode-codemode"
