...
export const TypeId: TypeId = "~@zerocode-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@zerocode-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@zerocode-ai/effect-sqlite-node/NodeSqliteClient")
