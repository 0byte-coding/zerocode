...
> current private `@0codeai/zerocode-llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@0codeai/zerocode-ai`
...
import { LLM } from "@0codeai/zerocode-ai"
import { OpenAI } from "@0codeai/zerocode-ai/providers/openai"
...
```ts
import { Message } from "@0codeai/zerocode-ai"
...
import { LLM, Tool } from "@0codeai/zerocode-ai"
...
```ts
import { LLM } from "@0codeai/zerocode-ai/promise"
import { OpenAI } from "@0codeai/zerocode-ai/providers/openai"
...
```ts
import { LLMSchema } from "@0codeai/zerocode-ai/schema"
...
```ts
import { Provider, Protocol } from "@0codeai/zerocode-ai/provider"
...
@0codeai/zerocode-ai/promise
  Promise/AsyncIterable LLM facade

@0codeai/zerocode-ai/schema
  serializable domain schemas

@0codeai/zerocode-ai/provider
  experimental Provider and Protocol authoring APIs

@0codeai/zerocode-ai/providers/openai
@0codeai/zerocode-ai/providers/anthropic
@0codeai/zerocode-ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@0codeai/zerocode-llm`                      | `@0codeai/zerocode-ai`                                           |
