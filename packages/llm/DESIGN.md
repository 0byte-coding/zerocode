...
> current private `@zerocode-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@zerocode-ai/ai`
...
import { LLM } from "@zerocode-ai/ai"
import { OpenAI } from "@zerocode-ai/ai/providers/openai"
...
```ts
import { Message } from "@zerocode-ai/ai"
...
import { LLM, Tool } from "@zerocode-ai/ai"
...
```ts
import { LLM } from "@zerocode-ai/ai/promise"
import { OpenAI } from "@zerocode-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@zerocode-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@zerocode-ai/ai/provider"
...
@zerocode-ai/ai/promise
  Promise/AsyncIterable LLM facade

@zerocode-ai/ai/schema
  serializable domain schemas

@zerocode-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@zerocode-ai/ai/providers/openai
@zerocode-ai/ai/providers/anthropic
@zerocode-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@zerocode-ai/llm`                      | `@zerocode-ai/ai`                                           |
