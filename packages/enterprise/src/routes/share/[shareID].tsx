import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@zerocode-ai/sdk/v2"
import { SessionTurn } from "@zerocode-ai/session-ui/session-turn"
import { SessionReview } from "@zerocode-ai/session-ui/session-review"
import { DataProvider } from "@zerocode-ai/session-ui/context"
import { FileComponentProvider } from "@zerocode-ai/ui/context/file"
import { WorkerPoolProvider } from "@zerocode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@zerocode-ai/ui/logo"
...
import { MessageNav } from "@zerocode-ai/session-ui/message-nav"
import { FileSSR } from "@zerocode-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@zerocode-ai/session-ui/pierre/worker").then((m) => ({
