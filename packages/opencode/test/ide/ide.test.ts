...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZEROCODE_CALLER", () => {
    process.env["ZEROCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZEROCODE_CALLER", () => {
    process.env["ZEROCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZEROCODE_CALLER", () => {
    process.env["ZEROCODE_CALLER"] = "unknown"
