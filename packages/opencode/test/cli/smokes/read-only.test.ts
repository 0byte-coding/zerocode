...
describe("opencode read-only commands (smoke)", () => {
  ...
  // ZEROCODE_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh ZEROCODE_TEST_HOME means
  ...
  // in production it'd be a path under ZEROCODE_TEST_HOME / XDG_DATA_HOME.
