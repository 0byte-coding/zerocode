#!/usr/bin/env bun
// Publishes the ghcr.io Docker image and updates the AUR + Homebrew tap
// packages for a real @0codeai/zerocode release. Needs docker login,
// AUR_KEY (SSH), and a GITHUB_TOKEN with push access to the homebrew tap -
// none of which are required just to publish the npm packages.
import { $ } from "bun"
...
if (Script.preview) {
  console.log("skipping docker/AUR/homebrew for a preview build")
  process.exit(0)
}
