...
import { ProjectDirectoryTable, ProjectTable } from "@0codeai/zerocode-core/project/sql"
import { ProjectDirectories } from "@0codeai/zerocode-core/project/directories"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ZEROCODE_FAKE_VCS)
