...
import { errorMessage } from "@0codeai/zerocode-tui/util/error"
...
import { win32InstallCtrlCGuard } from "@0codeai/zerocode-tui/terminal-win32"

declare global {
  const ZEROCODE_WORKER_PATH: string
}
...
async function target() {
  if (typeof ZEROCODE_WORKER_PATH !== "undefined") return ZEROCODE_WORKER_PATH
