...
import type * as SDK from "@0codeai/zerocode-sdk/v2"
...
import { SessionShareTable } from "@0codeai/zerocode-core/share/sql"
...
const disabled = process.env["ZEROCODE_DISABLE_SHARE"] === "true" || process.env["ZEROCODE_DISABLE_SHARE"] === "1"
