...
import { EventSequenceTable, EventTable } from "@0codeai/zerocode-core/event/sql"
...
import { WorkspaceEvent } from "@0codeai/zerocode-schema/workspace-event"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ZEROCODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ZEROCODE_WORKSPACE_ID: config.id,
        ZEROCODE_EXPERIMENTAL_WORKSPACES: "true",
