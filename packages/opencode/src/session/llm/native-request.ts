import type { JsonSchema, LLMRequest, ProviderMetadata } from "@zerocode-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@zerocode-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @zerocode-ai/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
