import type { JsonSchema, LLMRequest, ProviderMetadata } from "@0codeai/zerocode-llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@0codeai/zerocode-llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @0codeai/zerocode-llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
