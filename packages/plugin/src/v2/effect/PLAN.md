...
- Effect plugins import `@0codeai/zerocode-plugin/v2/effect`, not `@0codeai/zerocode-core`.
- Public domain values use generated `@0codeai/zerocode-sdk` types.
...
- Define `PluginHost` domain capabilities in `@0codeai/zerocode-plugin/v2/effect`.
