...
- Effect plugins import `@zerocode-ai/plugin/v2/effect`, not `@zerocode-ai/core`.
- Public domain values use generated `@zerocode-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@zerocode-ai/plugin/v2/effect`.
