...
const releaseId = process.env.ZEROCODE_RELEASE
if (!releaseId) throw new Error("ZEROCODE_RELEASE is required")

const version = process.env.ZEROCODE_VERSION
if (!version) throw new Error("ZEROCODE_VERSION is required")
