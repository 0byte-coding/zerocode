...
import { compile, emitEffectImported, emitPromise, write } from "@0codeai/zerocode-httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@0codeai/zerocode-protocol/groups/event"',
            },
          },
        }),
