...
import { compile, emitEffectImported, emitPromise, write } from "@zerocode-ai/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@zerocode-ai/protocol/groups/event"',
            },
          },
        }),
