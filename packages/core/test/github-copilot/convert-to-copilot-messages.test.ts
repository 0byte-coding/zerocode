import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@zerocode-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
