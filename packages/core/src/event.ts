...
import type { Data, Definition, Payload } from "@0codeai/zerocode-schema/event"
...
import { Durable } from "@0codeai/zerocode-schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@0codeai/zerocode-schema/event").ID
export type { Data, Definition, Payload } from "@0codeai/zerocode-schema/event"
