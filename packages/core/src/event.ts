...
import type { Data, Definition, Payload } from "@zerocode-ai/schema/event"
...
import { Durable } from "@zerocode-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@zerocode-ai/schema/event").ID
export type { Data, Definition, Payload } from "@zerocode-ai/schema/event"
