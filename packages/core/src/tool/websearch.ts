...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.ZEROCODE_WEBSEARCH_PROVIDER === "exa" || process.env.ZEROCODE_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.ZEROCODE_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("ZEROCODE_EXPERIMENTAL") || truthy("ZEROCODE_ENABLE_EXA") || truthy("ZEROCODE_EXPERIMENTAL_EXA"),
    enableParallel: truthy("ZEROCODE_ENABLE_PARALLEL") || truthy("ZEROCODE_EXPERIMENTAL_PARALLEL"),
