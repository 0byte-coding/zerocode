...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/0byte-coding/zerocode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for 0byte-coding/zerocode...\n")
