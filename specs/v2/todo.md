...
- remove the public in-memory `@0codeai/zerocode-llm` tool loop after replacing its
...
- decide whether to preserve deprecated `@0codeai/zerocode-llm` orchestration exports
