...
- `@0codeai/zerocode-effect-drizzle-sqlite`
...
1. Add `@0codeai/zerocode-effect-drizzle-sqlite` with a minimal in-memory/file SQLite test schema.
...
4. Add `@0codeai/zerocode-effect-drizzle-sqlite` as a dependency of `packages/opencode`.
